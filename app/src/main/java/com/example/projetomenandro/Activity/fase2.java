...
public class fase2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        gridLayout = findViewById(R.id.grindLayout);
    ...
    private void checkMatch() {
        if (images.get(firstCard).equals(images.get(secondCard))) {
            score++;
            if (score == 4) { // Ajuste para a nova quantidade de pares
    ...
    private void showCongratulations() {
        Intent intent = new Intent(fase2.this, Congratulations.class);
        intent.putExtra("FASE_ATUAL", 2);  // Indicando que a fase 2 foi concluída
